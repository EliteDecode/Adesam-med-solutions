                            ...
                            <tbody>
                                <?php 
                                    ...
                                    if(isset($_GET['date'])){
                                        ...
                                        $qb = selectSum('saved_data_liquor', 'Quantity_before', ['Product' => $ud['Product'], 'DateReg' => $date , 'Category' => $ud['Type']] );
                                        $qa = selectSum('saved_data_liquor', 'Quantity_after', ['Product' => $ud['Product'], 'DateReg' => $date , 'Category' => $ud['Type']] );
