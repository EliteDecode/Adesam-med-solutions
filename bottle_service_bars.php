        ...
        <div class="col-md-6 col-sm-12" style="background-color: #fafafa">
            <div class="container p-5">
                ...
                <div class="row mt-5">
                    ...
                    <?php endif ?>
                    <?php  if(isset($_SESSION['users'])): ?>
                    <a href="bottle_service.php?bar=bar2" class='col-md-4 mb-5 '>
                        <div class=" flex rounded-md items-center justify-center bg-white shadow-md hover:shadow-none cursor-pointer  p-3"
                            style='height: 15vh;'>
                    ...
                    <?php else: ?>
                    <a href="login.php?bar=bar2&route=bottle_service" class='col-md-4 mb-5'>
                        <div class="  flex rounded-md items-center justify-center bg-white shadow-md hover:shadow-none cursor-pointer  p-3"
                            style='height: 15vh;'>
                            <h2 class='flex justify-center font-bold text-lg uppercase'>Bar 2</h2>
                        </div>
                    ...
                    <?php endif ?>
                    <?php  if(isset($_SESSION['users'])): ?>
                    <a href="bottle_service.php?bar=bar3" class='col-md-4 mb-5 '>
                        <div class=" flex rounded-md items-center justify-center bg-white shadow-md hover:shadow-none cursor-pointer  p-3"
                            style='height: 15vh;'>
                    ...
                    <?php else: ?>
                    <a href="login.php?bar=bar3&route=bottle_service" class='col-md-4 mb-5'>
                        <div class="  flex rounded-md items-center justify-center bg-white shadow-md hover:shadow-none cursor-pointer  p-3"
                            style='height: 15vh;'>
                            <h2 class='flex justify-center font-bold text-lg uppercase'>Bar 3</h2>
                        </div>
                    ...
                    <?php endif ?>
                    <?php  if(isset($_SESSION['users'])): ?>
                    <a href="bottle_service.php?bar=bar4" class='col-md-4 mb-5 '>
                        <div class=" flex rounded-md items-center justify-center bg-white shadow-md hover:shadow-none cursor-pointer  p-3"
                            style='height: 15vh;'>
                    ...
                    <?php else: ?>
                    <a href="login.php?bar=bar4&route=bottle_service" class='col-md-4 mb-5'>
                        <div class="  flex rounded-md items-center justify-center bg-white shadow-md hover:shadow-none cursor-pointer  p-3"
                            style='height: 15vh;'>
                            <h2 class='flex justify-center font-bold text-lg uppercase'>Bar 4</h2>
                        </div>
                    ...
                    <?php endif ?>
                    <?php  if(isset($_SESSION['users'])): ?>
                    <a href="bottle_service.php?bar=bar5" class='col-md-4 mb-5 '>
                        <div class=" flex rounded-md items-center justify-center bg-white shadow-md hover:shadow-none cursor-pointer  p-3"
                            style='height: 15vh;'>
                    ...
                    <?php else: ?>
                    <a href="login.php?bar=bar5&route=bottle_service" class='col-md-4'>
                        <div class="  flex rounded-md items-center justify-center bg-white shadow-md hover:shadow-none cursor-pointer  p-3"
                            style='height: 15vh;'>
                            <h2 class='flex justify-center font-bold text-lg uppercase'>Bar 5</h2>
                        </div>
                    ...
                    <?php endif ?>
                    <?php  if(isset($_SESSION['users'])): ?>
                    <a href="bottle_service.php?bar=bar6" class='col-md-4 '>
                        <div class=" flex rounded-md items-center justify-center bg-white shadow-md hover:shadow-none cursor-pointer  p-3"
                            style='height: 15vh;'>
                    ...
                    <?php else: ?>
                    <a href="login.php?bar=bar6&route=bottle_service" class='col-md-4'>
                        <div class="  flex rounded-md items-center justify-center bg-white shadow-md hover:shadow-none cursor-pointer  p-3"
                            style='height: 15vh;'>
                            <h2 class='flex justify-center font-bold text-lg uppercase'>Bar 6</h2>
                        </div>
